...
import org.example.mopl.content.exception.RetryableTheSportsDbApiException;
...
public class TheSportsDbSoccerCrawlerClient implements SportCrawlerClient {
  ...
  public List<String> fetchLeagues() {
    ...
    } catch (TheSportsDbApiException e) {
      throw RetryableTheSportsDbApiException.createIfRetryable(e);
    }
